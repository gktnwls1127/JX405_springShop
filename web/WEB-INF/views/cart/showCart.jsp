    ...
    <div class="row">
        <div class="col-8" style="border: 1px solid black">
            <div style="padding: 20px 20px; font-weight: bold; font-size: 16px; border-bottom: 1px solid #000; position: relative;">
                CART
                <span><input id="product_select_all" class="all_check_input" onclick="selectAll()" type="checkbox"
                             checked="checked" style="position: absolute; right: 20px; top: 22px;"></span>
            </div>
            <table class="col-12">
                <c:forEach items="${cartList}" var="items">
                    <c:if test="${items.ordered ne 'ordered'}">
                        <tr class="cartList">
                            <td class="cartImg">
                            ...
                            <td class="cartInfo">
                                    ...
                                    <ul>
                                        <li>
                                            <span>${items.name}</span>(<span
                                                class="productCount">${items.productCount}</span>개)
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="cartPrice"
                                    ...
                                    <input type="hidden" class="cartPrice_input"
                                           value="${items.price * items.productCount}">
                                ...
                                <dl class="cartQty"
                                    ...
                                    <input id="input-quantity" class="quantity" name="quantity" size="2"
                                           value="${items.productCount}" onchange="countChange()"
                                           type="text"
            ...
            <c:if test="${countOrdered ne 0}">
                <div style="padding: 20px; border-bottom: 1px solid #000; display: flex;">
                    <a href="#none" class="select_delete" onclick="delRow()"
                       style="flex: 0 0 auto; width: 50%; color: #a8a9ad; font-size: 15px; letter-spacing: -0.1em;">선택
                        상품 삭제</a>
                    <a href="#none" class="all_delete" onclick="deleteAll()"
                       style="flex: 0 0 auto; width: 50%; color: #a8a9ad; font-size: 15px; letter-spacing: -0.1em; text-align: right;">전체
                        상품 삭제</a>
                </div>
            </c:if>
        </div>
        ...
        <div class="col-4 " style="border: 1px solid black">
            ...
            <div class="bagArea_sum mb-5" style="text-align: center; padding: 20px 20px 0;">
                ...
                <ul style="margin: 0 0 10px; font-size: 0; display: flex; padding-left: 0px;">
                    ...
                    <li class="deliveryPrice"
                        ...
                        <span id="total_delv_price_front" class="total_delv_price_front"><fmt:formatNumber
                                pattern="#,###원" value=""/></span>
            ...
            <div>
                <button class="btn btn-info col-12 mb-5"
                        style="border-radius: 30px; background-color: #fe62b6 !important; border-color: #fe62b6; font-size: 20px"
                        onclick="buyButton()">구매하기
                </button>
            </div>
        </div>
    </div>
