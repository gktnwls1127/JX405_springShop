...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div style="margin: 50px" class="row align-items-center mt-5">
                <div class="col">
                    ...
                    <table class="rwd-table">
                        ...
                        <c:forEach items="${memberList}" var="items">
                            <tr class="KOTRA-fontsize-80">
                                ...
                                <td>
                                    <button class="btn btn-danger delete"
                                            onclick="location.href='/member/delete/${items.id}'">
                                        Delete
                                    </button>
                                </td>
                            </tr>
            ...
            <canvas class="my-4 w-100" id="myChart" width="946" height="499"
                    style="display: block; box-sizing: border-box; height: 499px; width: 946px;">
